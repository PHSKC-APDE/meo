...
email_list <- yaml::read_yaml("C:/Users/jwhitehurst/OneDrive - King County/R/MEO/config_other/meo.covid.vac.email.yaml")
...
email %>%
  smtp_send(
    to = email_list$to_email,
    from = email_list$from_email,
